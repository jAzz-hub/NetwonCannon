...
void desenhar() {
  ...
  DesenharSprite(spriteCanhao, XVirtualParaReal(planeta.posicao.x - 10),
                 YVirtualParaReal(planeta.posicao.y + planeta.raio + 15),
                 tamanhoVirtualParaReal(25), tamanhoVirtualParaReal(25), 0, 1);
  ...
  DesenharSprite(spriteTorre, XVirtualParaReal(planeta.posicao.x),
                 YVirtualParaReal(planeta.posicao.y + planeta.raio),
                 tamanhoVirtualParaReal(1920 / 10),
